...
class _HomeRiderPageState extends State<HomeRiderPage> {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: Column(
          ...
          children: [
            _buildSectionTitle('รายการอาหารที่ต้องจัดส่ง'),
            Expanded(
              child: isLoading
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => EditProfile(
                  userName: _userName,
                  userEmail: '', // เพิ่มข้อมูลจริงถ้ามี
                  userPhone: '',
  ...
  Widget _buildEmptyOrder() => Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            ElevatedButton.icon(
              ...
              label: Text('รีเฟรช', style: GoogleFonts.fredoka()),
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => DeliveryDetailsPage(order: order),
                  ),
                );
              },
              style: ElevatedButton.styleFrom(
              ...
              child: Text('รับงาน', style: GoogleFonts.fredoka()),
            ),
          ],
        ),
      ),
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => EditProfile(
              ...
              userPhone: '', // Replace with actual user phone if available
              userImage: _userImage,
              userAddress: '', // Replace with actual user address if available
            ),
          ),
        );
        break;
