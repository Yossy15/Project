...
class _LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _authService = AuthService(loginUrl: login);
              ...
              builder: (context) => Column(
                ...
                children: [
                  ListTile(
                    ...
                    title: const Text('สมัครเป็น User'),
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const SignUpScreen(userType: 'user'),
                        ),
                      );
                    },
                  ),
                  ListTile(
                    ...
                    title: const Text('สมัครเป็น Rider'),
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const SignUpScreen(userType: 'rider'),
                        ),
                      );
                    },
                  ),
                  ListTile(
                    ...
                    title: const Text('สมัครเป็น Sender'),
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const SignUpScreen(userType: 'send'),
                        ),
                      );
                    },
                  ),
