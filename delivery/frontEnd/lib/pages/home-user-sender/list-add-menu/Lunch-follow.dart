...
class _LunchFollowPageState extends State<LunchFollowPage> with WidgetsBindingObserver {
  ...
  Future<void> _loadRoute() async {
    ...
    final response = await http.get(
      ...
      headers: {
        'Authorization': 'YOUR_API_KEY', // Add your OpenRouteService API Key here
    ...
    return FlutterMap(
      ...
      children: [
        ...
        PolylineLayer(
          polylines: [
            Polyline(
              points: [_currentPosition, const LatLng(16.246671218679253, 103.25207957788868)],
              strokeWidth: 4.0,
              color: Colors.red,
            ),
            Polyline(
  ...
  Widget _buildExpandedDetails(Map<String, dynamic> order) {
    return Column(
      ...
      children: [
        ...
        const Text('Rider Details', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        const SizedBox(height: 12),
